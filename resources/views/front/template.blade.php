...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <body>
	...
	<header role="banner">
		...
		<div class="brand">{{ trans('front/site.title') }}
		</div>
		...
		<nav class="navbar navbar-default" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.html">{{ trans('front/site.title') }}
						<img class="img-responsive img-max img- left" src="{!! asset('img/' . 'logoJA_2.svg') !!}" alt="">
					</a>
				</div>
	...
	<footer role="contentinfo">
		<li class="dropdown">
		 ...
		 @yield('footer')
		<p class="text-center"><small>Copyright &copy; Jeremy Ballot</small></p>
